...
public class KeyboardUtil {
    ...
    public void setCallBack(OnKeyBoardCallBack mCallBack) {
        this.mCallBack = mCallBack;
    }

    public KeyboardUtil(Activity activity, MyKeyBoardView view) {
        this(activity, view,false);
    }

    public KeyboardUtil(Activity activity,MyKeyBoardView view, boolean ifRandom) {
